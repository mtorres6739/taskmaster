...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.SettingsTextEditUsername),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("mdtorres83"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.MainActivityTextViewUsernameTasks), withText("mdtorres83's Tasks"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView.check(matches(withText("mdtorres83's Tasks")));
    }
